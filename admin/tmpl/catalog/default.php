...
<div class="table-responsive">
	...
	<tr>
        ...
        -->
        <th scope="col"><?php echo Text::_('COM_ACCOUNTING_ID'); ?></th>
		<th scope="col">
			<?php echo HTMLHelper::_('searchtools.sort', 'COM_ACCOUNTING_LOCALIZATION', 'a.localization', $listDirn, $listOrder); ?>
		</th>
		<th scope="col"><?php echo Text::_('COM_ACCOUNTING_TABLE'); ?></th>
	...
	<?php foreach ($this->items as $i => $item) :
		$canChange        = $user->authorise('core.edit.state', 'com_accounting.catalog.' . $item->id);
	?>
	<tr>
        ...
        -->
		<td>
			<a href="<?php echo Route::_('index.php?option=com_accounting&task=catalog.edit&id=' . $item->id ); ?>"
			title="<?php echo Text::_('JACTION_EDIT'); ?> <?php echo $this->escape($item->localization); ?>">
			<?php echo Text::_($item->localization); ?></a>
		</td>
