...
namespace Accountingroot\Component\Accounting\Administrator\View\Cataloglist8;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function addToolbar(): void
	{
		...
		ToolbarHelper::title(Text::_('COM_ACCOUNTING_CLIENTS'));
		...
		$childBar->link('COM_ACCOUNTING_CLIENTS8','index.php?option=com_accounting&amp;view=cataloglist8&id=5','COM_ACCOUNTING_CLIENTS8');
