...
namespace Accountingroot\Component\Accounting\Administrator\View\Cataloglist;
...
class HtmlView extends BaseHtmlView
{
	...
	{
		$objectName = $this->_models[$this->_name]->alias;
		
		ToolbarHelper::title(Text::_($objectName));
